...
% The number of spaces touched by every player must equal number_of_moves -- BUG
:- not number_of_moves * number_of_players {touch(T,C): color(C), player(C, player)} number_of_moves * number_of_players.
